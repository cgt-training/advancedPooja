...
?>
<div class="company-view" style="color:#337AB7">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                'label' => 'Company Logo',
                'format' => 'html',
                'value' => Html::img('@web/frontend/web/'.$model->getAttribute('company_logo'),['width' => '150px','class'=>'img-responsive center-block']),
            ],
        ],
    ]) ?>
